...
def register_datasets(args):
    ...
    os.environ['DATA_ROOT'] = args.os.environ['DATA_ROOT']
    ...
    target1_train_panoptic_json = os.path.join(os.environ['os.environ['DATA_ROOT']'],'pan_cityscapes_reduced/cityscapes_panoptic_train_trainId.json')
    target1_train_sem_seg_root = os.path.join(os.environ['os.environ['DATA_ROOT']'],'pan_cityscapes_reduced/train_sem_stuff')
