...
labels = [
    ...
    Label("parking sign", 19, 255, "object", 3, False, True, (220, 20, 60)),
    ...
    Label("rider", 32, 11, "human", 6, True, False, (255, 0, 0)),
    # original was Label("rider", 32, 12, "human", 6, True, False, (255, 0, 0)),
    ...
    Label("caravan", 36, 13, "vehicle", 7, True, False, (0, 0, 90)),
    #original was Label("caravan", 36, 255, "vehicle", 7, True, True, (0, 0, 90)),
    Label("motorcycle", 37, 13, "vehicle", 7, True, False, (0, 0, 230)),
    Label("trailer", 38, 255, "vehicle", 7, True, True, (0, 0, 110)),
    Label("train", 39, 13, "vehicle", 7, True, False, (0, 80, 100)),
    Label("truck", 40, 13, "vehicle", 7, True, False, (0, 0, 70)),
]
